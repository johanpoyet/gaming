<nav>
	<ul>
		...
		<li><a href="index.php?page=jeux"><i class="material-icons">view_list</i><span class="icon-text">catalogue des jeux</span></a></li>		
		...
		<li><a href="index.php?page=contact"><i class="material-icons">contact</i><span class="icon-text">NOUS CONTACTER</span></a></li>
	</ul>
</nav>